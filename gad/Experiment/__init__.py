...
from .EvalForBotnetDetection import BotnetDetectionEval as botnet_detection_eval
from .EvalForBotnetDetection import TimeBasedBotnetDetectionEval as timebased_botnet_detection_eval
